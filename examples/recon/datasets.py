...
# Mono class
class_id_map = {'0': 'human'}

class MonoShapeNet(object):
    
    def __init__(self, directory=None, class_id=None, set_name=None):
        ...
        # change images shape
        images = np.concatenate(images, axis=0).reshape((-1, 4, 64, 64))  # base images dataset shape = (num_pictures, multiview_points, 4, image_height, image_width)
