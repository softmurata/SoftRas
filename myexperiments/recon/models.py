...
class Encoder(nn.Module):
    def __init__(self, dim_in=4, dim_out=512, dim1=64, dim2=1024, im_size=64):
        ...
        # input => (4, 64, 64)
        dim_hidden = [dim1, dim1*2, dim1*4, dim2, dim2]  # (64, 128, 256, 1024, 1024)

        # we have possibility of increasing the number of net
        # we have to learn how to construct convolution network(in particular, how to set hidden layer dim, kernel size, stride and padding)
        # we should refer to famous network in order to add new layer
